...
function registreer() {
    ...
    var persoon = scrumlib.createDataset({
        "familienaam": sFamilienaam, "voornaam": sVoornaam, "geboortedatum": sGeboortedatum, "email": sEMail, "nickname": sGebruikersnaam, "beroep": sBeroep,
